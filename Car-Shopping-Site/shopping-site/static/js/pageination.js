var pageination='<script type="text/x-template" id="pageination">\n' +
    ...
    '            <div @click="pageUp(0)" class="pagination_page" :class="startDisabled?\'disabled\':\'\'">THE FIRST PAGE</div>\n' +
    '            <div @click="pageUp(1)" class="pagination_page" :class="startDisabled?\'disabled\':\'\'">last</div>\n' +
    ...
    '                {{item}}\n' +
    '            </div>\n' +
    '            <div @click="pageDown(1)" class="pagination_page" :class="endDisabled?\'disabled\':\'\'">next</div>\n' +
